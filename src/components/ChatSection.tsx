...
import { getMessages, addMessage, subscribeToMessages, type ChatMessage } from '../store';
...
export default function ChatSection({ category }: { category: string }) {
  ...
  useEffect(() => {
    ...
    // Realtime subscription بدل الـ interval
    const channel = subscribeToMessages(category, (msg) => {
